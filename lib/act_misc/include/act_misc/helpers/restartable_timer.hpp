...
/**
 * @brief A restartable timer class that allows starting, stopping, and restarting a timer with a
 *        specified duration. The timer can be configured to be periodic or one-shot.
...
class RestartableTimer
{
  ...
  public:
     ...
     *                         construction
     */
    explicit RestartableTimer(const AbsLogger &logger,
  ...
  public:
     ...
     * @note If the timer is currently running, the new duration will take effect on the start of
     *       the next period.
