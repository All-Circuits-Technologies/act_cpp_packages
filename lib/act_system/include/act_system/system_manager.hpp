...
class SystemManager : public act::foundation::AbsManager
{
  public:
    /**
     * @brief Constructor
     */
    explicit SystemManager(act::logger::AbsLogger &parentLogger);
  ...
  public:
     ...
     * @note We use popen to capture the command output, execl needs to be used in a forked
     * process or it will replace the current process and kill the application at the end.
     * @param cmd The command to execute
     * @param output The output of the command
     * @param logger The logger to use for logging errors
     * @return The return code of the command
     */
    static int CallCommand(const std::string &cmd,
                           std::ostream &output,
